...
class SimpleTopo(Topo):
    ...
    def build(self, n=2, bw=10):
        ...
        self.description_for_qjump = ("Simple topology with %d hosts and link bandwidth " % n) + ("unlimited" if bw is None else "%s Mbit/s" % bw)
...
class DCTopo(Topo):
    ...
    def build(self, bw=10):
        ...
        self.description_for_qjump = "Datacenter topology used by authors with link bandwidth " + ("unlimited" if bw is None else "%s Mbit/s" % bw)
